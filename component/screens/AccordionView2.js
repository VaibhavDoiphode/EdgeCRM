...
const AccordionView2 = ({disabled1, setDisabled1, setDisabled2}) => {
  ...
  return (
    <View style={styles.accordion}>
      ...
      <View style={expanded ? styles.headerLine2 : styles.headerLine1}>
          <Text style={styles.headerText}>Accordian2</Text>
                ...
                <RadioButton.Group
                  ...
                  <View style={styles.radioButtonContainerSection}>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="Yes" disabled={disabled1} />
                      <Text>Yes</Text>
                    </View>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="No" disabled={disabled1} />
                      <Text>No</Text>
                    </View>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="NA" disabled={disabled1} />
                      <Text>NA</Text>
                    </View>
                  </View>
                </RadioButton.Group>
