...
const AccordionView3 = ({disabled2, setDisabled2, setDisabled3}) => {
  ...
  return (
    <View style={styles.accordion}>
      ...
      <View style={expanded ? styles.headerLine2 : styles.headerLine1}>
          <Text style={styles.headerText}>Accordian3</Text>
                ...
                <RadioButton.Group
                  ...
                  <View style={styles.radioButtonContainerSection}>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="Yes" disabled={disabled2} />
                      <Text>Yes</Text>
                    </View>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="No" disabled={disabled2} />
                      <Text>No</Text>
                    </View>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="NA" disabled={disabled2} />
                      <Text>NA</Text>
                    </View>
                  </View>
                </RadioButton.Group>
