...
const AccordionView1 = ({disabled, setDisabled, setDisabled1}) => {
    ...
    <View style={styles.accordion}>
      <TouchableOpacity onPress={toggleSize}>
        <View style={expanded ? styles.headerLine2 : styles.headerLine1}>
          <Text style={styles.headerText}>Accordian1</Text>
        ...
        {expanded && (
          <TouchableWithoutFeedback>
            <View style={expanded ? styles.expandedHeaderLine : styles.hidden}>
                ...
                <RadioButton.Group
                  ...
                  <View style={styles.radioButtonContainerSection}>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="Yes" disabled={disabled} />
                      <Text>Yes</Text>
                    </View>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="No" disabled={disabled} />
                      <Text>No</Text>
                    </View>
                    <View style={styles.radioButtonContainer}>
                      <RadioButton value="NA" disabled={disabled} />
                      <Text>NA</Text>
                    </View>
                  </View>
                </RadioButton.Group>
              ...
              <View style={styles.mcqText}>
                <Text style={styles.questionText}>Advice Given</Text>
                <RadioButton.Group
